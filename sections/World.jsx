  ...
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div className={`${styles.innerWidth} mx-auto flex flex-col`}
      ...
      <motion.div className='relative mt-[68px] flex w-full h-[550px]'
        ...
        <div className='absolute bottom-[30%] right-[20%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]'>
        ...
        <div className='absolute top-[32%] left-[50%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]'>
